...
<script src="https://cdn.jsdelivr.net/gh/pwndrer4/i/dcrm.min.js" type="text/javascript"></script>
		<script src="//lib.baomitu.com/jquery/1.11.2/jquery.min.js"></script>
	</head>
...
<fieldset class="box">
	...
	<center>	<img class="icon" height ="30"width ="30" src="<?php echo(SITE_URL); ?>icon/default/cydia.png" />
			<div>
				<div>
					<label>
						<p>
...
a{ color: rgba(0, 0, 0, 0.7.5);outline: none;text-decoration: none;-webkit-transition: 0.2s;transition: 0.2s;}
a:hover,a:focus{color:#450e61;text-decoration: none;}
