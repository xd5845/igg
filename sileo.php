...
if(empty($shots)){//无图时默认图片地址
  $shots = array('https://img14.360buyimg.com/ddimg/jfs/t1/139976/30/18289/638257/5fd5dbfeE36dd3af3/38b8830f6f861028.png');
}else{
	foreach($shots as $k=>$v){//截图域名添加
    	$shots[$k] = 'https://apt.w4ze.cn/'.$domain.$v;
    }
}
...
$arr['headerImage'] = 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1579419736255&di=f3d74b085085ab169430a374bbf19cbb&imgtype=0&src=http%3A%2F%2Fimg.pconline.com.cn%2Fimages%2Fupload%2Fupc%2Ftx%2Fsoftbbs%2F1108%2F29%2Fc0%2F8802417_1314588763714_1024x1024soft.jpg';
$arr['tabs'][0]['tabname'] = '插件介绍';
$arr['tabs'][0]['views'][0]['markdown'] = '插件描述：'.$package_info['Description'].''.$package_info['Multi'].'';
...
$arr['tabs'][0]['views'][10]['markdown'] = '专注于收集精品插件分享做最简洁、纯净无广告的源';
...
$arr['tabs'][1]['views'][0]['markdown'] = '如果使用上遇到任何问题,尝试用以下方式联系我们';
$arr['tabs'][1]['views'][0]['class'] = 'DepictionMarkdownView';
$arr['tabs'][1]['views'][1]['title'] = '源主QQ';
$arr['tabs'][1]['views'][1]['action'] = 'mqqwpa://im/chat?chat_type=wpa&uin=2648616832&version=1&src_type=web&web_src=lvlingseeds.com';
$arr['tabs'][1]['views'][1]['class'] = 'DepictionTableButtonView';
$arr['tabs'][1]['views'][2]['title'] = '交流QQ群';
$arr['tabs'][1]['views'][2]['action'] = 'https://qm.qq.com/cgi-bin/qm/qr?k=1nzqHMx8hy6zrxmWio6uS5K5c5ZPBGXd&authKey=gvfCskX0hyTKn060fKRKwJK6%2FsJaPq9wZ%2Bm%2Fno3TiZjWU0Dv3OnPees3eVhibiqJ';
$arr['tabs'][1]['views'][2]['class'] = 'DepictionTableButtonView';
$arr['tabs'][1]['views'][3]['title'] = '电子邮箱';
$arr['tabs'][1]['views'][3]['action'] = 'mailto:2648616832@qq.com';
$arr['tabs'][1]['views'][3]['class'] = 'DepictionTableButtonView';
$arr['tabs'][1]['views'][4]['class'] = 'DepictionSeparatorView';
$arr['tabs'][1]['views'][5]['markdown'] = 'Alan中文源专注于收集精品插件分享，做最简洁、纯净无广告的源';
